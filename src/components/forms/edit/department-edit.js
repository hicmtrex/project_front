...
const DepartmentEdit = ({ handleClose, show, currentId }) => {
  ...
  const department = departments.find((d) => d.id === currentId);
  const {
    register,
    handleSubmit,
    reset,
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            {...register('DATE_DERNIER_MODIF', {
              value: department?.DATE_DERNIER_MODIF,
            })}
